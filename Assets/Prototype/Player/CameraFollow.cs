...
public class CameraFollow : MonoBehaviour {
	...
	void Start(){
		...
		*/
		...
		westCameraBoxCollider.size = new Vector2 (0.5f, Camera.main.orthographicSize * 2f);
		...
		eastCameraBoxCollider.size = new Vector2 (0.5f, Camera.main.orthographicSize * 2f);
